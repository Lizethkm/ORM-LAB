...
def problem_one(request):
    ...
    students_gpa= Student.objects.filter(gpa__gt=3).order_by('-gpa')
...
def problem_five(request):
    adding_student= Student.objects.create(first_name='Kyle', last_name='Hardwood', year= 12, gpa= 3.0)
    print(f'Id: {adding_student.id}')
    print(f'Full Name: {adding_student.first_name} {adding_student.last_name}')
    print(f'Year: {adding_student.year}')
    print(f'GPA: {adding_student.gpa}')
...
def problem_six(request):
    ...
    new_student_gpa= Student.objects.get(pk=student_id)
    
    print(f'ID: {new_student_gpa.id}')
    print(f'Full Name: {new_student_gpa.first_name} {new_student_gpa.last_name}')
    print(f'GPA: {new_student_gpa.gpa}')
    return complete(request)
